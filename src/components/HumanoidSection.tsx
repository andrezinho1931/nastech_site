              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    Elimine tarefas repetitivas e foque no crescimento do seu negócio. Ganhe até <strong>20 horas por semana</strong>.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    Diminua erros humanos e otimize recursos. Economize até <strong>40% em custos operacionais</strong>.
                  </p>
                </div>
              </div>
            </div>
